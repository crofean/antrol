    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div class="lg:col-span-1 space-y-6">
            <div class="glass rounded-3xl p-6 shadow-sm">
                ...
                <form method="GET" action="{{ route('referensi.pendaftaran') }}" class="space-y-4">
                    ...
                    <div class="pt-4 flex gap-2">
                        ...
                        <a href="{{ route('referensi.pendaftaran') }}" class="glass px-4 py-2.5 rounded-xl text-slate-500 hover:text-red-500 transition-colors"><i class="fas fa-undo"></i></a>
                    </div>
                </form>
            </div>
                 ...
                 <div class="bg-blue-50 dark:bg-blue-900/10 border-l-4 border-blue-600 p-6 rounded-2xl mb-8">
                    <div class="flex items-start gap-4">
                        ...
                        <p class="text-sm text-blue-700 dark:text-blue-400 font-medium leading-relaxed">
                            ...
                            Sistem akan mensesuaikan status Mobile JKN dengan status kunjungan hospital yang riil.
                        </p>
                    </div>
                </div>
...
<script>
    ...
    function updateStatus() {
        ...
        fetch('{{ route("referensi.pendaftaran") }}', {
            method: 'POST',
            body: formData,
